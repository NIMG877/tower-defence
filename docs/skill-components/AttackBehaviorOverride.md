...
Overrides an entity's attack `DamageType` and/or target `OrderLogic`. It can
...
| `orderLogic` | String | omitted | New `OrderLogic` enum name. Changed only when this parameter exists. |
